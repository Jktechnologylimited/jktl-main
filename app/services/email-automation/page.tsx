...
export const metadata: Metadata = {
  ...
  description: "Follow up with every lead automatically — while you focus on delivery. ₦100,000 – ₦400,000.",
};
      ...
      <section style={{ background:"var(--navy-950)", paddingTop:"120px", paddingBottom:"80px" }}>
        <div className="max-w-5xl mx-auto px-8">
          ...
          <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"1.6rem", fontWeight:300, color:"var(--gold-300)", marginBottom:"28px" }}>
            ₦100,000 – ₦400,000
            <span style={{ fontSize:"1rem", color:"rgba(249,247,240,0.4)", marginLeft:"10px" }}>+ ₦20,000 – ₦100,000/mo</span>
          </p>
        ...
        <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div style={{ padding:"24px", background:"var(--navy-900)", borderRadius:"4px" }}>
              ...
              <p style={{ fontFamily:"'Cormorant Garamond',serif", fontWeight:300, fontSize:"1.1rem", color:"rgba(249,247,240,0.4)", marginBottom:"20px" }}>to ₦400,000</p>
              <p className="label-xs" style={{ color:"var(--gold-400)", marginBottom:"16px" }}>₦20,000 – ₦100,000/mo</p>
