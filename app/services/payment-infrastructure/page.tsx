...
const s = services.find(x => x.slug === "payment-infrastructure")!;

export const metadata: Metadata = {
  title: "Payment & Business Infrastructure | JK Technology Limited",
  description: "Accept payments online -- seamlessly, professionally, and automatically. N100,000 - N600,000.",
};
    ...
    <>
      <section style={{ background:"var(--navy-950)", paddingTop:"120px", paddingBottom:"80px" }}>
        <div className="max-w-5xl mx-auto px-8">
          <p className="label-xs" style={{ color:"var(--gold-400)", marginBottom:"10px" }}>06 -- Infrastructure</p>
          <h1 className="display-hero mb-4" style={{ color:"var(--cream-50)" }}>Payment & Business Infrastructure</h1>
          <p className="body-lg" style={{ color:"rgba(249,247,240,0.58)", maxWidth:"560px", marginBottom:"24px" }}>Accept payments online -- seamlessly, professionally, and automatically</p>
          ...
          <div style={{ display:"flex", flexWrap:"wrap", gap:"12px" }}>
            ...
            <TryDemoButton href="/demos/payments" label="Try Demo First" variant="outline" style={{ borderColor:"rgba(249,247,240,0.4)", color:"rgba(249,247,240,0.8)" }} />
        ...
        <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div style={{ padding:"24px", background:"var(--navy-900)", borderRadius:"4px" }}>
              ...
              <p style={{ fontFamily:"'Cormorant Garamond',serif", fontWeight:300, fontSize:"1.1rem", color:"rgba(249,247,240,0.4)", marginBottom:"20px" }}>to N600,000</p>
              
              <a href={`mailto:${siteConfig.email}`} className="btn-gold" style={{ width:"100%", justifyContent:"center" }}>Get Started</a>
              <div style={{ marginTop:"10px" }}>
                <TryDemoButton href="/demos/payments" label="Try Live Demo First" variant="outline" style={{ width:"100%", justifyContent:"center" }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <DemoCallout
        demoSlug="payments"
        demoTitle="Payment & Billing System"
        demoDescription="Build a real invoice with editable line items, generate a payment link, and preview a branded receipt -- all live in the browser. See how your clients would pay you."
        accentColor="#059669"
        extraDemos={[{ slug: "crm", label: "CRM System" }, { slug: "business-tools", label: "Free Business Tools" }]}
      />
      <CTA />
    </>
  );
