...
export const metadata: Metadata = {
  ...
  description: "Accept payments online — seamlessly, professionally, and automatically. ₦100,000 – ₦600,000.",
};
        ...
        <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div style={{ padding:"24px", background:"var(--navy-900)", borderRadius:"4px" }}>
              ...
              <p style={{ fontFamily:"'Cormorant Garamond',serif", fontWeight:300, fontSize:"1.8rem", color:"var(--cream-50)", lineHeight:1, marginBottom:"4px" }}>₦100,000</p>
              <p style={{ fontFamily:"'Cormorant Garamond',serif", fontWeight:300, fontSize:"1.1rem", color:"rgba(249,247,240,0.4)", marginBottom:"20px" }}>to ₦600,000</p>
