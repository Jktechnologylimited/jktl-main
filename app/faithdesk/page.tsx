...
export const metadata: Metadata = {
  title: "FaithDesk -- Ministry Management Software | JK Technology",
  description: "FaithDesk is complete management software for churches and ministries. Members, tithes, offerings, analytics. Self-service onboarding.",
};

function fmtN(n: number) { return "N" + n.toLocaleString("en-NG"); }

export default function ProductPage() {
  const product = deskProducts.find(p => p.id === "faithdesk")!;
