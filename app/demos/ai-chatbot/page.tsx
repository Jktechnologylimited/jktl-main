...
export const metadata: Metadata = {
  title: "AI Chatbot & Automation Demo | JK Technology Limited",
  description: "Live AI assistant trained on your business -- qualifies leads, answers questions, books appointments, and hands off to your team.",
  alternates: { canonical: "https://jktl.com.ng/demos/ai-chatbot" },
};

const subdomains = [
  { label: "Law Firm Chatbot", url: "https://lawfirm-chatbot.jktl.com.ng", desc: "Trained on legal services, practice areas, and consultation booking" },
  { label: "Clinic Chatbot", url: "https://clinic-chatbot.jktl.com.ng", desc: "Trained on clinic services, appointment booking, and patient FAQs" },
  { label: "Business Chatbot", url: "https://business-chatbot.jktl.com.ng", desc: "Trained on general business services and lead qualification" },
];
    ...
    <div style={{ background: "var(--cream-50)", minHeight: "100vh", paddingTop: "80px" }}>
      ...
      <div style={{ background: "var(--navy-900)", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" }}>
            <div style={{ width: 32, height: 32, background: "#0F172A", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "0.68rem", fontWeight: 700, color: "#fff" }}>07</span>
            </div>
          ...
          <p style={{ fontSize: "0.72rem", color: "rgba(249,247,240,0.45)" }}>
            Live AI assistant trained on your business -- qualifies leads, answers questions, books appointments, and hands off to your team.
          </p>
        </div>
      ...
      <div style={{ maxWidth: "1200px", margin: "32px auto", padding: "0 24px" }}>
          ...
          <div key={sub.label} style={{ marginBottom: "40px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px", flexWrap: "wrap", gap: "10px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <div style={{ width: 28, height: 28, background: "#0F172A", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <a href={sub.url} target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "7px 14px", background: "transparent", border: "1px solid #0F172A", color: "#0F172A", fontSize: "0.72rem", fontWeight: 700, textDecoration: "none", borderRadius: "2px", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Open Full Screen
        ...
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "8px" }}>
          ...
          <Link href="/demos/business-tools" className="btn-outline-navy">Next: Free Business Tools</Link>
