...
export const metadata: Metadata = {
  title: "Free Business Tools Demo | JK Technology Limited",
  description: "Invoice Generator, Receipt Generator, Profit Calculator, and Pricing Calculator -- professional tools free forever.",
  alternates: { canonical: "https://jktl.com.ng/demos/business-tools" },
};

const subdomains = [
  { label: "Invoice Generator", url: "https://invoice.jktl.com.ng", desc: "Free -- unlimited invoices, custom branding, PDF download" },
  { label: "Receipt Generator", url: "https://receipt.jktl.com.ng", desc: "Free -- branded receipts, QR code, print and download" },
  { label: "Profit Calculator", url: "https://profit.jktl.com.ng", desc: "Free -- real margin analysis, break-even, net profit" },
  { label: "Pricing Calculator", url: "https://pricing.jktl.com.ng", desc: "Free -- cost-plus pricing, competitor benchmark, margin slider" },
];
      ...
      <div style={{ background: "var(--navy-900)", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" }}>
            <div style={{ width: 32, height: 32, background: "#C9A84C", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "0.68rem", fontWeight: 700, color: "#fff" }}>08</span>
            </div>
          ...
          <p style={{ fontSize: "0.72rem", color: "rgba(249,247,240,0.45)" }}>
            Invoice Generator, Receipt Generator, Profit Calculator, and Pricing Calculator -- professional tools free forever.
          </p>
        </div>
          ...
          <div key={sub.label} style={{ marginBottom: "40px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px", flexWrap: "wrap", gap: "10px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <div style={{ width: 28, height: 28, background: "#C9A84C", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <a href={sub.url} target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "7px 14px", background: "transparent", border: "1px solid #C9A84C", color: "#C9A84C", fontSize: "0.72rem", fontWeight: 700, textDecoration: "none", borderRadius: "2px", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Open Full Screen
