...
export const metadata: Metadata = {
  title: "SEO & Google Visibility Demo | JK Technology Limited",
  description: "Full SEO dashboard -- keyword rankings, Google SERP preview, SEO health score, local search visibility, and monthly reports.",
  alternates: { canonical: "https://jktl.com.ng/demos/seo" },
};

const subdomains = [
  { label: "SEO Dashboard Demo", url: "https://seo-demo.jktl.com.ng", desc: "Enter your business name and city to see your simulated SEO audit" },
];
    ...
    <div style={{ background: "var(--cream-50)", minHeight: "100vh", paddingTop: "80px" }}>
      ...
      <div style={{ background: "var(--navy-900)", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" }}>
            <div style={{ width: 32, height: 32, background: "#DC2626", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "0.68rem", fontWeight: 700, color: "#fff" }}>06</span>
            </div>
          ...
          <p style={{ fontSize: "0.72rem", color: "rgba(249,247,240,0.45)" }}>
            Full SEO dashboard -- keyword rankings, Google SERP preview, SEO health score, local search visibility, and monthly reports.
          </p>
        </div>
      ...
      <div style={{ maxWidth: "1200px", margin: "32px auto", padding: "0 24px" }}>
          ...
          <div key={sub.label} style={{ marginBottom: "40px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px", flexWrap: "wrap", gap: "10px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <div style={{ width: 28, height: 28, background: "#DC2626", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <a href={sub.url} target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "7px 14px", background: "transparent", border: "1px solid #DC2626", color: "#DC2626", fontSize: "0.72rem", fontWeight: 700, textDecoration: "none", borderRadius: "2px", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Open Full Screen
        ...
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "8px" }}>
          ...
          <Link href="/demos/ai-chatbot" className="btn-outline-navy">Next: AI Chatbot</Link>
