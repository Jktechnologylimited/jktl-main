...
export const metadata: Metadata = {
  title: "CRM & Business Operations Demo | JK Technology Limited",
  description: "Full CRM dashboard -- manage leads, track pipeline stages, view analytics, log activities, and never lose a client again.",
  alternates: { canonical: "https://jktl.com.ng/demos/crm" },
};

const subdomains = [
  { label: "Law Firm CRM", url: "https://lawfirm-crm.jktl.com.ng", desc: "Pre-loaded with legal clients, cases, and billing pipeline" },
  { label: "Clinic CRM", url: "https://clinic-crm.jktl.com.ng", desc: "Pre-loaded with patient records, appointments, billing" },
  { label: "Business CRM", url: "https://business-crm.jktl.com.ng", desc: "Generic business CRM for any service or product company" },
];
    ...
    <div style={{ background: "var(--cream-50)", minHeight: "100vh", paddingTop: "80px" }}>
      ...
      <div style={{ background: "var(--navy-900)", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" }}>
            <div style={{ width: 32, height: 32, background: "#D97706", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "0.68rem", fontWeight: 700, color: "#fff" }}>04</span>
            </div>
          ...
          <p style={{ fontSize: "0.72rem", color: "rgba(249,247,240,0.45)" }}>
            Full CRM dashboard -- manage leads, track pipeline stages, view analytics, log activities, and never lose a client again.
          </p>
        </div>
      ...
      <div style={{ maxWidth: "1200px", margin: "32px auto", padding: "0 24px" }}>
          ...
          <div key={sub.label} style={{ marginBottom: "40px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px", flexWrap: "wrap", gap: "10px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <div style={{ width: 28, height: 28, background: "#D97706", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <a href={sub.url} target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "7px 14px", background: "transparent", border: "1px solid #D97706", color: "#D97706", fontSize: "0.72rem", fontWeight: 700, textDecoration: "none", borderRadius: "2px", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Open Full Screen
        ...
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "8px" }}>
          ...
          <Link href="/demos/payments" className="btn-outline-navy">Next: Payment System</Link>
